...
/*
  The Gujarati twin of /testimonials. It renders the identical component — the
  ...
  Open Graph locale.
*/
export { default } from "../../testimonials/page";
...
export const metadata: Metadata = staticPageMetadata("/testimonials", "gu");
