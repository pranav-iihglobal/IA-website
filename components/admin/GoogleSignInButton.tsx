...
/** Google's mark, from their branding guidelines. */
function GoogleMark() {
  return (
 ...
 *
 * `redirectTo` carries the page the visitor was trying to reach, so being
 * bounced to sign-in does not also lose their place.
 */
