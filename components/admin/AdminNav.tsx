...
import { ENTITY_ICON_PATHS } from "@/lib/admin/entity-icons";
    ...
    items: [
      {
        ...
        label: "Invoices",
        needs: "billing:read",
        icon: <Icon path={ENTITY_ICON_PATHS.Invoice} />,
      },
      {
      ...
      },
      {
        ...
        label: "Schemes",
        needs: "billing:read",
        icon: <Icon path={ENTITY_ICON_PATHS.Scheme} />,
      },
      {
        href: "/admin/gst",
        module: "billing",
    ...
    items: [
      {
        ...
        owns: ["/admin/contacts"],
        icon: <Icon path={ENTITY_ICON_PATHS.Contact} />,
      },
      {
        href: "/admin/dealers",
        label: "Dealers",
    ...
    items: [
      {
        ...
        label: "Products",
        needs: "products:read",
        icon: <Icon path={ENTITY_ICON_PATHS.Product} />,
      },
      {
        href: "/admin/stock",
        module: "billing",
        label: "Stock",
        needs: "billing:read",
        icon: <Icon path={ENTITY_ICON_PATHS.StockItem} />,
      },
      {
        ...
        label: "Purchases",
        needs: "billing:read",
        icon: <Icon path={ENTITY_ICON_PATHS.Purchase} />,
      },
      {
        ...
        label: "Suppliers",
        needs: "billing:read",
        icon: <Icon path={ENTITY_ICON_PATHS.Supplier} />,
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        icon: <Icon path={ENTITY_ICON_PATHS.Testimonial} />,
      },
      {
        href: "/admin/blog",
        module: "posts",
        label: "Blog",
        needs: "posts:read",
        icon: <Icon path={ENTITY_ICON_PATHS.Post} />,
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        needs: "users:manage",
        strip: false,
        icon: <Icon path={ENTITY_ICON_PATHS.Settings} />,
      },
      {
        href: "/admin/activity",
        label: "Activity",
      ...
      },
      {
        ...
        needs: "users:read",
        strip: false,
        icon: <Icon path={ENTITY_ICON_PATHS.User} />,
      },
    ],
  },
];
